...
Piece* GameStatus::pieceEnPassantable(PieceColor color)
{
	if(color==PieceColor::WHITE) 
	{
		return whitePieceEnPassant;
	}
	else 
	{
		return blackPieceEnPassant;
	}
}
...
bool GameStatus::isFirstColRookMove(PieceColor color)
{
	if(color==PieceColor::WHITE) 
	{
		return whiteFirstColRookMove;
	}
	else 
	{
		return blackFirstColRookMove;
	}
}
...
bool GameStatus::isLastColRookMove(PieceColor color)
{
	if(color==PieceColor::WHITE) 
	{
		return whiteLastColRookMove;
	}
	else 
	{
		return blackLastColRookMove;
	}
}
